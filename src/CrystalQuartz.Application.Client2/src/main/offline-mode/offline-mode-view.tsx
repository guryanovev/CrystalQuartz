...
export class OfflineModeView implements View, OnInit, OnUnrender {
    ...
    constructor(
        private readonly viewModel: OfflineModeViewModel
    ) {
    }
    ...
    public template(): HtmlDefinition {
        return <section class="offline-mode d-flex flex-row align-items-center justify-content-center" $className={{ 'visible': this._visible }}>
            <div class="offline-mode-overlay"></div>
            <div class="offline-mode-container">
                <section class="offline-mode-body d-flex flex-column">
                    <h1>Server is offline since <span>{this.viewModel.since}</span></h1>
                    ...
                    <footer class="d-flex justify-content-between">
                        ...
                        <button
                            ...
                            class="btn btn-light"
                            disabled={map(this.viewModel.isInProgress, inProgress => inProgress ? 'disabled' : undefined)}
